...
First, create a directory for the Sepedi language files within your `resources/lang` directory:

```
resources/
└── lang/
    └── nso/  <-- Create this directory
        ├── auth.php
        ├── pagination.php
        ├── passwords.php
        ├── validation.php
...
Now, create the following PHP files within the `nso` directory and add the corresponding Sepedi translations.

**resources/lang/nso/auth.php**

```php
<?php

return [
    'failed' => 'Ga di nyalelane le mangwalo a go hlatsela a rena.',
    'password' => 'Password ga e nepagale.',
    'throttle' => 'Mekgwa e mentši haholo. Ka kopo leka gape ka mor\'a metsotsoana e :seconds.',
    'login' => 'Tsenya',
    'register' => 'Ngwadiša',
    'name' => 'Leina',
    'email' => 'Imeile',
    ...
    'forgot_your_password' => 'O lebetše password ya gago?',
    'reset_password' => 'Seta Botsjha Password',
    'send_password_reset_link' => 'Romela kgokagano ya go seta botsjha password',
    'old_password' => 'Password ya Kgale',
    'new_password' => 'Password e Ntjha',
    'confirm_new_password' => 'Qinisekisa Password e Ntjha',
    'update_password' => 'Mpshafatša Password',
];
```

**resources/lang/nso/pagination.php**

```php
<?php

return [
    'previous' => '&laquo; E fetilego',
    'next' => 'E latelago &raquo;',
];
```

**resources/lang/nso/passwords.php**

```php
<?php

return [
    'reset' => 'Password ya gago e hlomilwe botjha!',
    'sent' => 'Re rometse sehokelo sa ho seta botsjha password ya gago ka imeile!',
    'throttled' => 'Ka kopo leta pele o leka hape.',
    'token' => 'Token ena ya ho seta botsjha password ga se ya nepa.',
    'user' => "Ha re kgone ho fumana mosebelisi ya nang le aterese ena ya imeile.",
];
```

**resources/lang/nso/validation.php**
...
return [
    ...
    'email' => 'The :attribute e tlameha ho ba aterese ya imeile e nepahetseng.',
    'ends_with' => 'The :attribute e tlameha ho qala ka e 'ngoe ho tse latelang: :values.',
    ...
    'integer' => 'The :attribute e tlameha ho ba palo e felletseng.',
    'ip' => 'The :attribute e tlameha ho ba aterese ea IP e nepahetseng.',
    'ipv4' => 'The :attribute e tlameha ho ba aterese ea IPv4 e nepahetseng.',
    'ipv6' => 'The :attribute e tlameha ho ba aterese ea IPv6 e nepahetseng.',
    'json' => 'The :attribute e tlameha ho ba khoele e nepahetseng ea JSON.',
    'lt' => [
        'numeric' => 'The :attribute e tlameha ho ba tlase ho :value.',
        'file' => 'The :attribute e tlameha ho ba tlase ho :value kilobytes.',
        'string' => 'The :attribute e tlameha ho ba tlase ho :value characters.',
        'array' => 'The :attribute e tlameha ho ba le lintho tse fokolang ho :value.',
    ],
    'lte' => [
        'numeric' => 'The :attribute e tlameha ho ba tlase kapa ho lekana le :value.',
        'file' => 'The :attribute e tlameha ho ba tlase kapa ho lekana le :value kilobytes.',
        'string' => 'The :attribute e tlameha ho ba tlase kapa ho lekana le :value characters.',
        'array' => 'The :attribute e tlameha ho ba le lintho tse fokolang kapa tse lekanang le :value.',
    ],
    'mac_address' => 'The :attribute e tlameha ho ba aterese ea MAC e nepahetseng.',
    'max' => [
        'numeric' => 'The :attribute e kanne ya se be kgolo ho :max.',
        'file' => 'The :attribute e kanne ya se be kgolo ho :max kilobytes.',
        'string' => 'The :attribute e kanne ya se be kgolo ho :max characters.',
        'array' => 'The :attribute e kanne ya se be le lintho tse fetang :max.',
    ],
    'mimes' => 'The :attribute e tlameha ho ba faele ya mofuta: :values.',
    'mimetypes' => 'The :attribute e tlameha ho ba faele ya mofuta: :values.',
    'min' => [
